  ...
  pages: [
    ...
    },
    {
      ...
      whatHappens: [
        ...
        "Если вас регистрировал администратор, ссылку на вход могут прислать в мессенджер или на email.",
    ...
    },
    {
      ...
      answer:
        "У кабинета родителя и кабинета ученика восстановление устроено по-разному. Родительский пароль можно сбросить на входе, а пароль ученика меняется через кабинет родителя.",
      whatHappens: [
    ...
    },
    {
      ...
      answer:
        "Запись делается через кабинет родителя. Рядом с именем ученика нужно открыть «Запись или отмена» и выбрать — вы хотите постоянное расписание или разовый урок.",
      whatHappens: [
    ...
    },
    {
      ...
      answer:
        "Ещё одного ученика можно добавить прямо в кабинете родителя. После этого он появится в вашей семье, и для него можно будет отдельно записать урок и настроить вход в кабинет ученика.",
      whatHappens: [
    ...
    },
    {
      ...
      answer:
        "Если вам нужно быстро проверить баланс или понять, что с оплатой — сначала идите в личный кабинет. Если вопрос уже про документы, возврат или сам платёж, лучше сразу писать в команду оплат.",
      whatHappens: [
    ...
    },
    {
      ...
      answer:
        "Чтобы первое занятие прошло спокойно, лучше заранее проверить не только вход в кабинет ученика, но и технику. Для урока нужен компьютер или ноутбук, наушники с микрофоном, нормальный браузер и рабочая связь.",
      whatHappens: [
    ...
    },
    {
      ...
      answer:
        "Для обычного урока главное — стабильный интернет, рабочий микрофон и нормальное устройство. В большинстве случаев лучше заниматься с компьютера или ноутбука, а не с телефона.",
      whatHappens: [
